...
<body>
	...
	<hr>
	<p>JSP 문서에서 생성된 객체를 내장객체의 속성값으로 저장하여 다른 JSP 문서에서 속성값을 반환받아
	사용할 수 있는 범위 - 내장객체에 따라 저장된 속성값의 사용범위가 다르게 설정</p>
	<hr>
	...
	- 같은 세션이 바인딩된(같은 클라이언트) 모든 JSP 문서에서 속성값을 객체로 반환받아 사용 가능</p>
	<p>application Scope : application 내장객체(WAS)를 이용하여 객체를 속성값으로 저장
	...
	- implicitObject.getAttribute(String attributeName, Object attributeValue)</p> 
	<p>내장객체에 저장된 속성값을 삭제하는 메소드
	- implicitObject.removeAttribute(String attributeName, Object attributeValue)</p> 
</body>
</html>