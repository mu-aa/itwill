...
<body>
	...
	<hr>
	<p>page(HttpJspPage) : JSP 문서정보를 제공하기 위한 객체(Java의 this개념 - 잘 안씀)</p>
	...
	<p>★response(HttpServletResponse) : 클라이언트에게 응답 정보를 제공하기 위한 객체</p>
	...
	<p>exception(Exception) : 웹프로그램 실행 시 발생된 예외를 제공하기 위한 객체
