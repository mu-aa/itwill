...
<%
	...
	//ㄴ 속성명을 이용하여 속성값을 구분 - 내장객체가 다른 경우 같은 이름의 속성명 사용 가능
	//ㄴ 내장객체에 동일한 속성명이 있는 경우 기존 속성값 대신 새로운 속성값으로 변경
	pageContext.setAttribute("pageName", "홍길동"); //page Scope
	request.setAttribute("requestName", "임꺽정"); //request Scope
	session.setAttribute("session", "전우치"); //session Scope
...
<body>
	...
	<%
		...
		//ㄴ 매개변수로 전달된 속성명의 속성값이 없는 경우 null 반환
