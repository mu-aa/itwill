...
public class VariableExample {
	public static void main(String[] args) {
		...
		int g=7, s=10;
		System.out.println("사각형의 넓이 = " + g*s);
		System.out.println("======================================================");
		...
		int cnt=10;
		double weight=759., avg=weight/cnt;
		
		System.out.println("몸무게 평균 = " + avg );
		System.out.println("======================================================");
		...
		String name = "홍길동";
		int kor=89, eng=93, math=95, tot=kor+eng+math;
		double avg2=tot/3.;
		System.out.println("이름 : "+ name);
		System.out.println("총점 : "+ tot);
		System.out.println("평균 : "+ (int)(avg2*10)/10.);
