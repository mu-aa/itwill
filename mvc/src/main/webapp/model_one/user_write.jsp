...
<%-- ㄴ [회원등록] 태그를 클릭한 경우 회원정보 삽입페이지(user_write_action.jsp)로 이동 - 입력값 전달 --%>
<%-- ㄴ [로그인] 태그를 클릭한 경우 로그인정보 입력페이지(user_login.jsp)로 이동 --%>
<%
	UserinfoDTO loginUserinfo=(UserinfoDTO)session.getAttribute("loginUserinfo");
	if(loginUserinfo==null || loginUserinfo.getStatus()!=9) { //비로그인 사용자거나 관리자가 아닌경우
