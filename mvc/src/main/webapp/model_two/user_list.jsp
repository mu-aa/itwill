...
<%-- ㄴ 회원정보에서 <회원이름>을 클릭한 경우 회원정보 출력페이지(view.do)로 이동 - 아이디 전달 --%>
<%-- ㄴ [회원등록] 태그를 클릭한 경우 회원정보 입력페이지(writeForm.do)로 이동 - 관리자만 요청 가능한 페이지--%>
<%-- ㄴ [로그아웃] 태그를 클릭한 경우 로그아웃 처리페이지(logout.do)로 이동 --%>
