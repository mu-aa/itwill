...
public class UserinfoController {
	...
	//아이디를 전달받아 USERINFO 테이블에 저장된 해당 아이디의 회원정보를 검색하여 속성값으로
	//저장하여 변경할 회원정보를 입력받기 위한 ViewName을 반환하는 요청 처리 메소드
	//ㄴ 비로그인 사용자 또는 관리자가 아닌 사용자가 페이지를 요청할 경우 권한 관련 인터셉터를 이용하여 처리
	...
	//회원정보를 전달받아 USERINFO 테이블에 저장된 회원정보를 변경하고 회원정보를 출력하는 페이지를 요청하기
	//위한 URL 주소를 클라이언트에게 전달하는 요청 처리 메소드
	//ㄴ 변경 처리하기 위한 사용자가 로그인 사용자인 경우 세션에 저장된 권한 관련 정보 변경
