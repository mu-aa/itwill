...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//List<MyMember> memberList=MyMemberXMLDAO.getDAO().selectMemberList(); XML
	//List<MyMember> memberList=MyMemberInterfaceDAO.getDAO().selectMemberList(); INTERFACE
	List<MyMember> memberList=MyMemberDAO.getDAO().selectMemberList(); //binding
%>    
