...
<body>
	...
	<table>
		...
		<tr>
			...
			<%-- <%=comment.getComment().getCommentId() %> --%>
			<td><%=commentUser.getUser().getUserName() %>(<%=commentUser.getUser().getUserId() %>)</td>
			<%-- <td><%=comment.getComment().getCommentContent() %></td> --%>
			<%-- <td><a href="commentReplySelect1.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"><%=commentUser.getComment().getCommentContent() %></a></td>  --%>
			<%-- <td><a href="commentReplySelect2.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"><%=commentUser.getComment().getCommentContent() %></a></td>  --%>
			<td><a href="commentReplyUserSelect.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"><%=commentUser.getComment().getCommentContent() %></a></td>
