...
function submit() {
	$("#expenses-table tr").each(function(i) {
		if(i==0) return;
		
		var array=["exNo","exDate","exCash","exCard","exAcname","exCate","exMemo","exId"];
		var data=[];
 ...
 <body>
	...
	<p><input type="hidden" value="${budget1}" id="budget1"></p>
	<p><input type="hidden" value="${budget2}" id="budget2"></p>
	<p><input type="hidden" value="${budget3}" id="budget3"></p>
	<p><input type="hidden" value="${budget4}" id="budget4"></p>
	<p><input type="hidden" value="${budget5}" id="budget5"></p>
	<p><input type="hidden" value="${budget6}" id="budget6"></p>
	<p><input type="hidden" value="${budget7}" id="budget7"></p>
	<p><input type="hidden" value="${budget8}" id="budget8"></p>
	<p><input type="hidden" value="${budget9}" id="budget9"></p>
	<p><input type="hidden" value="${budget10}" id="budget10"></p>
	<p><input type="hidden" value="${budget11}" id="budget11"></p>
	...
	function selectAll(selectAll)  {
 	...
 	$(function() {
		...
		var bwon1=$("#budget1").val(); //예산값 hidden으로 전달
		var bwon2=$("#budget2").val();
		var bwon3=$("#budget3").val();
		var bwon4=$("#budget4").val();
		var bwon5=$("#budget5").val();
		var bwon6=$("#budget6").val();
		var bwon7=$("#budget7").val();
		var bwon8=$("#budget8").val();
		var bwon9=$("#budget9").val();
		var bwon10=$("#budget10").val();
		var bwon11=$("#budget11").val();
		
		//그래프 값 추출
		//ㄴ a:예산값 / b:초과분 / c:지출값
		var a=[bwon1, bwon2, bwon3, bwon4, bwon5, bwon6, bwon7, bwon8, bwon9, bwon10, bwon11];
